...
- [x] Markdown рендеринг з підсвіткою коду ✅
- [x] Копіювання коду одним кліком ✅
- [x] Регенерація відповіді ✅
- [x] Мінімалістичний дизайн зі slate кольорами ✅
- [x] Редагування попередніх повідомлень ✅
- [x] Експорт розмови (MD/JSON) ✅
...
### SEO
- [x] Meta tags для всіх сторінок ✅
- [x] Open Graph previews ✅
- [x] Sitemap.xml ✅
- [x] robots.txt ✅
